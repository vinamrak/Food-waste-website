...
<body style="background-color: #222222;color: white;font-family: 'Noto Sans', sans-serif;">
    ...
    <div class="mx-4 my-2 py-4" id="aboutus">
        ...
        <div>
        We are a team of three members studying at Vellore Institue of Technology, Vellore, pursuing B.Tech in Computer Science. Our Contact Details can be found below on the same page.
        </div>
    </div>
    ...
    <div class="mx-4 my-2 py-4" id="contact">
        ...
        <div>
            <p>
            <h4 class="gold-color">VINAMRA KHORIA</h4>
            vinamra.khoria2019@vitstudent.ac.in<br>
            19BCE0624<br>
            </p>
            <p>
            <h4 class="gold-color">DEVANSH BAID</h4>
            devansh.baid2019@vitstudent.ac.in<br>
            19BCE0468<br>
            </p>
            <p>
            <h4 class="gold-color">AMIT KRISHNA</h4>
            amit.krishna2019@vitstudent.ac.in<br>
            19BCE0197<br>
            </p>
        </div>
    </div>
